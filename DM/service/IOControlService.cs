...
namespace DM.service
{
    interface IOControlService
    {
        ...
        void InsertIOData(string filpath, IOInformationEntity ioInfo);
        ...
        /// <returns></returns>
        IOInformationEntity QueryByID(string filePath, string tableName, string id);
        ...
        void UpdateData(string filePath, string tableName, string id, IOInformationEntity ioInfo);
    }
}
